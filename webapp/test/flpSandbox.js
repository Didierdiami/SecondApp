		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "2nd App",
									"targetURL": "#soapeoplecomsecondapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"soapeoplecomsecondapp-display": {
								"semanticObject": "soapeoplecomsecondapp",
								"action": "display",
								"description": "Test 2",
								"title": "2nd App",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=soapeople.com.second.app",
									"url": sap.ui.require.toUrl("soapeople/com/second/app")
								}
							}
						}
					}
